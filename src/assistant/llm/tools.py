...
def create_tool_registry(
    ...
    # Register Hacker News tool if enabled
    if settings and settings.hackernews_enabled:
        registry.register(
            HACKERNEWS_TOOL_DEF["name"],
            HACKERNEWS_TOOL_DEF["description"],
            HACKERNEWS_TOOL_DEF["input_schema"],
            hackernews,
        )
